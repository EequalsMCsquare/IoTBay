...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width,http://java.sun.com/jsp/jstl/core  initial-scale=1, shrink-to-fit=no">
        ...
        <div class="row">
            <div class="table-responsive">
                <table class="table table-striped m-b-none" id="tbl">
                    ...
                    <c:forEach items="${sessionScope.paymentDetails}" var="item" varStatus="xh">
                        <tr>
                            <td>${item.id}</td>
                            <td>${item.orderId}</td>
                            <td>${item.amount}</td>
                            ...
                            <td>${item.date}</td>
                            <td>
                                <button class="btn btn-info" type="button" onclick="edit(${item.id})">edit</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="paymentDetailServlet?action=add" method="post">
                            <div class="form-group">
                                <label>OrderId</label>
                                <select class="form-control" name="orderId">
                                    <c:forEach items="${orders}" var="item" varStatus="xh">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="paymentDetailServlet?action=edit" method="post">
...
<script>
    ...
    function edit(id, name, expireDate, cardNumber) {
        $("#id").val(id);
        $("#name").val(name);
    ...
    function del(id) {
        window.location.href = "paymentDetailServlet?action=delete&id=" + id;
    }
