        ...
        <div class="container d-flex justify-content-between">
            ...
            <div>
                ...
                <%
                    if (staff != null) {
                %>
                <button class="btn btn-success" type="button" onclick="window.location='supplier?operate=list'">Admin</button>
                <%
                    }
                %>
...
<body>
	<fieldset>
		...
		<form action="supplier?operate=search" method="post">
			<div class="form-row">
			...
			<c:forEach items="${list}" var="item" varStatus="idx">
				<tr>
					...
					<td><input type="button" name="name"
						...
						value="EDIT" /> <a href="supplier?operate=delete&id=${item.id}"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-group style='margin:0 auto'"
						action="supplier?operate=edit" method="post">
	...
	<div class="modal fade" id="add" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-group style='margin:0 auto'"
						action="supplier?operate=create" method="post">
